...
<page orientation="portrait" format="210x330" style="font-size: 8pt">
	...
	<table class="disdukcapil" style="margin-top: 0px;">
		...
		<tr>
			<td>&nbsp;</td>
			<td colspan="13" style="text-align: center;">(&nbsp;<?= padded_string_center(strtoupper($config['nama_kepala_camat']),30)?>&nbsp;)</td>
			<td>&nbsp;</td>
		...
		<tr>
			<td>&nbsp;</td>
			<td colspan="13" style="text-align: center;"><?= "NIP&nbsp;&nbsp;:&nbsp;".$config['nip_kepala_camat']?></td>
			<td>&nbsp;</td>
