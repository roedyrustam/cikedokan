	...
	<div class="content-wrapper">
		<section class="content-header">
			<div class="title-header">Surat Keterangan Tidak Mampu</div>
			<?php if ($this->admin) : ?>
				<ol class="breadcrumb">
							...
							<form id="validasi" action="<?= $form_action ?>" method="POST" target="_blank" class="form-surat form-horizontal">
								...
								<?php if ($individu) : ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<a id="showData" class="btn btn-radius btn-uppercase btn-danger btn-sm"><i class="fa fa-search-plus"></i> Tampilkan</a>
											<a id="hideData" class="btn btn-radius btn-uppercase btn-danger btn-sm"><i class="fa fa-search-minus"></i> Sembunyikan</a>
										</div>
									</div>
