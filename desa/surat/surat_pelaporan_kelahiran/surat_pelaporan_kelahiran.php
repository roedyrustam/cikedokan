...
<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Surat Keterangan Kelahiran</div>
		<?php if ($this->admin) : ?>
			<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?= site_url($aksi . "surat") ?>" class="btn btn-radius btn-uppercase btn-default btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Wilayah">
							<i class="fa fa-arrow-circle-left "></i> Kembali Ke Daftar Cetak Surat
						</a>
						<a href="#" class="btn btn-radius btn-uppercase btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Lihat Info Isian Surat" data-toggle="modal" data-target="#infoBox" data-title="Lihat Info Isian Surat">
						...
						<form id="validasi" action="<?= $form_action ?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="col-md-12">
								...
								<?php if ($ibu) : ?>
									...
									$individu = $ibu;
									include("sidepeapps/views/surat/form/konfirmasi_pemohon.php");
									?>
									<?php if (!empty($ayah)) : ?>
										<div class="form-group">
								...
								<div class="form-group">
									<label for="berat_lahir" class="col-sm-3 control-label">Berat Bayi Kg</label>
									<div class="col-sm-2">
										<div class="input-group input-group-sm">
											<input class="form-control input-sm data_lahir" placeholder="Berat Kg Bayi" name="berat_lahir" id="input_group" type="text" value="<?= $_SESSION['post']['berat_lahir'] ?>" />
											<div class="input-group-addon" style="width:20px;">Kg</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<label for="berat_ons" class="col-sm-3 control-label">Berat Bayi Ons</label>
									<div class="col-sm-2">
										<div class="input-group input-group-sm">
											<input class="form-control input-sm data_lahir" placeholder="Berat Ons Bayi" name="berat_ons" id="input_group" type="text" value="<?= $_SESSION['post']['berat_ons'] ?>" />
											<div class="input-group-addon" style="width:20px;">Ons</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-2">
										<div class="input-group input-group-sm">
											...
											<div class="input-group-addon" style="width:20px;">cm</div>
										</div>
									</div>
								</div>
								<?php if ($ibu and !$bayi) : ?>
									<div class="form-group">
										...
										<div class="col-sm-2">
											<button type="button" onclick="buat_penduduk_baru();" class="btn btn-radius btn-uppercase btn-danger btn-sm"><span class="fa fa-download">&nbsp;</span> Buat Penduduk Baru</button>
										</div>
									</div>
								<?php endif; ?>
								<div class="form-group subtitle_head">
