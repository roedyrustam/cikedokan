<?php class Keluarga_model extends CI_Model {
	...
	*/
	...
	public function list_data($o=0, $offset=0, $limit=500)
	{
		...
		$sql = "SELECT u.*, t.nama AS kepala_kk, t.foto, t.nik, t.sex, t.status_dasar, (SELECT COUNT(id) FROM tweb_penduduk WHERE id_kk = u.id AND status_dasar = 1) AS jumlah_anggota, c.dusun, c.rw, c.rt ".$this->list_data_sql();
		$sql .= $order_sql;
		$sql .= $paging_sql;
