...
class Inventaris_laporan_model extends CI_Model
{
	...
	public function laporan_inventaris()
	{
		$laporan_inventaris = array(
			...
			array('inventaris_mesin_pribadi', 'inventaris_mesin', 'Pembelian Sendiri'),
			array('inventaris_mesin_pemerintah', 'inventaris_mesin', 'Bantuan Pemerintah'),
			array('inventaris_mesin_provinsi', 'inventaris_mesin', 'Bantuan Provinsi'),
			array('inventaris_mesin_kabupaten', 'inventaris_mesin', 'Bantuan Kabupaten'),
			array('inventaris_mesin_sumbangan', 'inventaris_mesin', 'Sumbangan'),
			...
			array('inventaris_elektronik_pribadi', 'inventaris_elektronik', 'Pembelian Sendiri'),
			array('inventaris_elektronik_pemerintah', 'inventaris_elektronik', 'Bantuan Pemerintah'),
			array('inventaris_elektronik_provinsi', 'inventaris_elektronik', 'Bantuan Provinsi'),
			array('inventaris_elektronik_kabupaten', 'inventaris_elektronik', 'Bantuan Kabupaten'),
			array('inventaris_elektronik_sumbangan', 'inventaris_elektronik', 'Sumbangan'),
		);
		$result = array();
	...
	public function cetak_inventaris($tahun)
	{
		$cetak_inventaris = array(
			...
			array('cetak_inventaris_mesin_pribadi', 'inventaris_mesin', 'Pembelian Sendiri', 'tahun_pengadaan'),
			array('cetak_inventaris_mesin_pemerintah', 'inventaris_mesin', 'Bantuan Pemerintah', 'tahun_pengadaan'),
			array('cetak_inventaris_mesin_provinsi', 'inventaris_mesin', 'Bantuan Provinsi', 'tahun_pengadaan'),
			array('cetak_inventaris_mesin_kabupaten', 'inventaris_mesin', 'Bantuan Kabupaten', 'tahun_pengadaan'),
			array('cetak_inventaris_mesin_sumbangan', 'inventaris_mesin', 'Sumbangan', 'tahun_pengadaan'),
			...
			array('cetak_inventaris_elektronik_pribadi', 'inventaris_elektronik', 'Pembelian Sendiri', 'tahun_pengadaan'),
			array('cetak_inventaris_elektronik_pemerintah', 'inventaris_elektronik', 'Bantuan Pemerintah', 'tahun_pengadaan'),
			array('cetak_inventaris_elektronik_provinsi', 'inventaris_elektronik', 'Bantuan Provinsi', 'tahun_pengadaan'),
			array('cetak_inventaris_elektronik_kabupaten', 'inventaris_elektronik', 'Bantuan Kabupaten', 'tahun_pengadaan'),
			array('cetak_inventaris_elektronik_sumbangan', 'inventaris_elektronik', 'Sumbangan', 'tahun_pengadaan'),
		);
		$result = array();
