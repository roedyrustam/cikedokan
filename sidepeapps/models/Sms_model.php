...
class Sms_model extends CI_Model {
	...
	{
		$sql = " FROM tweb_penduduk join tweb_wil_clusterdesa on tweb_penduduk.id_cluster = tweb_wil_clusterdesa.id WHERE tweb_penduduk.telepon is not null and tweb_penduduk.telepon != ''";
	...
	public function list_data_kontak($o = 0, $offset = 0, $limit = 500)
	{
		...
		//Main Query
		$sql = "SELECT *, telepon as no_hp " . $this->list_data_kontak_sql();
		$sql .= $paging_sql;
