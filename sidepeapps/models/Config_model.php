<?php class Config_model extends CI_Model {
	...
	private function uploadBanner(string $nama)
	{
		$this->load->library('upload');
		$this->uploadConfig = array(
			'upload_path' => 'desa/upload/widget/',
		...
		if ($this->upload->do_upload($nama))
		{
			...
			$fileRenamed = rename(
				...
				$this->uploadConfig['upload_path'].$nama.'.jpg'
			);
			// Ganti nama di array upload jika file berhasil di-rename --
			// jika rename gagal, fallback ke nama asli
			$uploadData['file_name'] = $fileRenamed ? $nama.'.jpg' : $uploadData['file_name'];
		}
		// Upload gagal
		else
		{
