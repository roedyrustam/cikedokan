...
class Lapor extends CI_Controller {
	...
	public function read($id)
	{
		...
		$this->load->view('header', $header);
		$this->load->view('nav', $nav);
		$this->load->view('lapor/read', $data);
		$this->load->view('footer');
	}
	...
	public function pending($id)
	{
		...
		$this->db->update('komentar', ['status' => 'Pending']);

		$this->komentar_lock($id);
	}
	...
	public function lanjut($id)
	{
		...
		$this->db->update('komentar', ['status' => 'Diteruskan']);
	...
	public function proses($id)
	{
		...
		$this->db->update('komentar', ['status' => 'Dalam Proses']);
	...
	public function selesai($id)
	{
		...
		$this->db->update('komentar', ['status' => 'Selesai']);
	...
	public function komentar_unlock($id = '')
	{
		...
		$this->db->update('komentar', ['status' => NULL]);
