<?php
	...
	*/
	...
	function hari($tgl)
		{
			...
			$hari = "";
			if($nama=="Sunday") {$hari="Minggu";}
			else if($nama=="Monday") {$hari="Senin";}
			else if($nama=="Tuesday") {$hari="Selasa";}
			else if($nama=="Wednesday") {$hari="Rabu";}
			else if($nama=="Thursday") {$hari="Kamis";}
			else if($nama=="Friday") {$hari="Jumat";}
			else if($nama=="Saturday") {$hari="Sabtu";}
			return $hari;
		}
	}
	...
	function bln_short($tgl, $replace_with='-') {
		if (date_is_empty($tgl)) {
			return $replace_with;
		}
		$tanggal = substr($tgl,8,2);
	...
	function tgl_indo3($tgl, $replace_with='-') {
		if (date_is_empty($tgl)) {
			return $replace_with;
		}
		$tanggal = substr($tgl,8,2);
	...
	function getBulan_short($bln_short){
				switch ($bln_short){
					case 1:
						return "01";
						break;
