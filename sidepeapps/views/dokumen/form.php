				...
				<div class="col-md-12">
					<div class="box box-info">
						<div class="box-header with-border">
							<a href="<?= site_url() . $this->controller . '/index/' . $kat ?>" class="btn btn-radius btn-uppercase btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Artikel">Kembali Ke Daftar <?= $kat_nama ?></a>
						</div>
						<div class="box-body">
							...
							<?php
							if ($kat == 2)
								include("sidepeapps/views/dokumen/_sk_kades.php");
							elseif ($kat == 3)
								include("sidepeapps/views/dokumen/_perdes.php");
							?>
						</div>
