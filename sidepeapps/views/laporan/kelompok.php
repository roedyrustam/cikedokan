...
<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Laporan Kelompok Rentan</div>
		<ol class="breadcrumb">
				...
				<form id="mainform" name="mainform" action="<?= site_url('laporan/bulan')?>" method="post" class="form-horizontal">
					<div class="box box-info">
						<div class="box-header with-border">
							<a href="<?= site_url("laporan_rentan/cetak")?>" class="btn btn-radius btn-uppercase bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  target="_blank">Cetak</a>
							<a href="<?= site_url("laporan_rentan/excel/$lap")?>" class="btn btn-radius btn-uppercase bg-green btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  target="_blank">Unduh</a>
						</div>
						<div class="box-header  with-border">
