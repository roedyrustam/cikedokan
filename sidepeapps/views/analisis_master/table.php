													...
													<table class="table table-bordered table-striped dataTable table-hover">
														<thead class="bg-gray disabled color-palette">
															<tr>
																...
																<?php if ($o==4): ?>
																	<th class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/3")?>">Nama <i class='fa fa-sort-asc fa-sm'></i></a></th>
																<?php elseif ($o==3): ?>
																	<th class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/4")?>">Nama <i class='fa fa-sort-desc fa-sm'></i></a></th>
																<?php else: ?>
																	<th class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/3")?>">Nama <i class='fa fa-sort fa-sm'></i></a></th>
																<?php endif; ?>
																<?php if ($o==6): ?>
																	<th nowrap class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/5")?>">Subjek/Unit Analisis <i class='fa fa-sort-asc fa-sm'></i></a></th>
																<?php elseif ($o==5): ?>
																	<th nowrap class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/6")?>">Subjek/Unit Analisis <i class='fa fa-sort-desc fa-sm'></i></a></th>
																<?php else: ?>
																	<th nowrap class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/5")?>">Subjek/Unit Analisis <i class='fa fa-sort fa-sm'></i></a></th>
																<?php endif; ?>
																<td class="text-center uppercase"><b>Petugas/Kelompok Sensus</b></td>
																<?php if ($o==2): ?>
																	<th nowrap class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/1")?>">Status <i class='fa fa-sort-asc fa-sm'></i></a></th>
																<?php elseif ($o==1): ?>
																	<th nowrap class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/2")?>">Status <i class='fa fa-sort-desc fa-sm'></i></a></th>
																<?php else: ?>
																	<th nowrap class="text-center uppercase"><a href="<?= site_url("analisis_master/index/$p/1")?>">Status <i class='fa fa-sort fa-sm'></i></a></th>
																<?php endif; ?>
															</tr>
														</thead>
														<tbody>
															<?php foreach ($main as $data): ?>
																<tr>
																	...
																	<td><?= $data['petugas']?></td>
																	<td width="5%" class="text-center"><?= $data['lock']?></td>
																</tr>
															<?php endforeach;?>
														</tbody>
													</table>
