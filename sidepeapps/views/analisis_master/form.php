					...
					<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data"  class="form-horizontal">
						<div class="box-body">
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class="col-sm-3 control-label" for="petugas">Petugas/Kelompok Sensus</label>
										<div class="col-sm-4">
											<input  id="petugas" class="form-control input-sm" type="text" placeholder="Nama Surveyor" name="petugas" value="<?= $analisis_master['petugas'] ?>">
										</div>
									</div>
								</div>
								<div class="col-sm-12">
