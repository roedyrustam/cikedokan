<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Pengaturan WhatsApp</div>
		<ol class="breadcrumb">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea id="link" name="link" class="form-control input-sm" placeholder="Nomor WhatsApp Pelayanan (Misal : +6281234567890)" style="height: 200px;"><?php if ($main): ?>https://api.whatsapp.com/send?phone=<?=$main['link'];?><?php endif; ?></textarea>
										</div>
									</div>
									<div class="form-group">
