<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Data Terdata Suplemen</div>
		<ol class="breadcrumb">
	...
	<section class="content" id="maincontent">
		<div class="row">
          ...
          <div class="box-header with-border">
						<a href="<?= site_url()?>suplemen/rincian/1/<?= $suplemen['id']?>" class="btn btn-radius btn-uppercase btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">Kembali Ke Rincian Suplemen</a>
					</div>
					<div class="box-header with-border">
