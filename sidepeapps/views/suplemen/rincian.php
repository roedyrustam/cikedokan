...
<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Rincian Data Suplemen</div>
		<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?= site_url("suplemen/form_terdata/".$suplemen['id'])?>" title="Tambah Data Warga" class="btn btn-radius btn-uppercase bg-olive btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">Tambah Warga Terdata</a>
						<a href="<?= site_url("suplemen/unduhsheet/$suplemen[id]")?>" class="btn btn-radius btn-uppercase bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh Data" target="_blank">Unduh</a>
												...
												<div class="table-responsive">
													<table class="table table-bordered dataTable table-striped table-hover">
														...
														<tbody>
															...
															?>
																<tr>
																	<td class="text-center" width="2"><?= $nomer; ?></td>
																	<td class="text-center" nowrap>
																		<?php if ($_SESSION['grup']==1): ?>
																			<a href="<?= site_url("suplemen/edit_terdata_form/$item[id]")?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Terdata" title="Ubah Terdata" class="btn btn-warning btn-radius-sm btn-sm"><i class="fa fa-edit"></i></a>
																			<a href="#" data-href="<?= site_url('suplemen/hapus_terdata/'.$suplemen["id"].'/'.$item["id"])?>" class="btn bg-maroon btn-radius-sm btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																		<?php endif; ?>
																	</td>
							...
							<div class='modal-dialog'>
								<div class='modal-content'>
									...
									<div class='modal-footer'>
										...
										<a class='btn-ok'>
											<button type="button" class="btn btn-radius btn-uppercase btn-info btn-sm" id="ok-delete">Simpan</button>
										</a>
									</div>
								</div>
							</div>
