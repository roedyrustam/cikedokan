							...
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover" >
									...
									<tr>
										...
										<td>:</td>
										<td class="uppercase"><?= $analisis_periode['nama']?></td>
									</tr>
								</table>
							</div>
						</div>
													...
													<div class="table-responsive">
														<table class="table table-bordered table-striped dataTable table-hover">
															<thead class="bg-gray disabled color-palette">
																<tr>
																	<th class="text-center uppercase" width="2%" style="font-size: 10px;">No</th>
																	<?php if ($o==4): ?>
																		<th class="text-center uppercase" style="font-size: 10px;" width="30%"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/3")?>">Pertanyaan/Indikator <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o==3): ?>
																		<th class="text-center uppercase" style="font-size: 10px;" width="30%"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/4")?>">Pertanyaan/Indikator <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else: ?>
																		<th class="text-center uppercase" style="font-size: 10px;" width="30%"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/3")?>">Pertanyaan/Indikator <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<th class="text-center uppercase" style="font-size: 10px;">Total</th>
																	<?php if ($o==2): ?>
																		<th class="text-center uppercase" width="8%" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/1")?>">Kode <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o==1): ?>
																		<th class="text-center uppercase" width="8%" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/2")?>">Kode <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else: ?>
																		<th class="text-center uppercase" width="8%" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/1")?>">Kode <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<th colspan="2" class="text-center uppercase" style="font-size: 10px;">Jawaban</th>
																	<th class="text-center uppercase" style="font-size: 10px;">Respon</th>
																	<th class="text-center uppercase" style="font-size: 10px;">Jumlah</th>
																	<?php if ($o==6): ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/5")?>">Tipe Pertanyaan <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o==5): ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/6")?>">Tipe Pertanyaan <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else: ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/5")?>">Tipe Pertanyaan <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<?php if ($o==6): ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/5")?>">Kategori/Variabel <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o==5): ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/6")?>">Kategori/Variabel <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else: ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/5")?>">Kategori/Variabel <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																	<?php if ($o==2): ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/1")?>">Aksi Analisis <i class='fa fa-sort-asc fa-sm'></i></a></th>
																	<?php elseif ($o==1): ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/2")?>">Aksi Analisis <i class='fa fa-sort-desc fa-sm'></i></a></th>
																	<?php else: ?>
																		<th class="text-center uppercase" style="font-size: 10px;"><a href="<?= site_url("analisis_statistik_jawaban/index/$p/1")?>">Aksi Analisis <i class='fa fa-sort fa-sm'></i></a></th>
																	<?php endif; ?>
																</tr>
															</thead>
															<tbody>
																<?php $total = 0; foreach ($main as $data): ?>
																	<tr>
																		...
																		<td class="text-center"><a href="<?= site_url("analisis_statistik_jawaban/grafik_parameter/$data[id]")?>" ><?= $data['bobot']?></a></td>
																		...
																		<td><?= $data['kategori']?></td>
																		<td class="text-center"><?= $data['act_analisis']?></td>
																	</tr>
																	<?php
																		if ($data['jumlah'] != "-"):
																			$total += $data['jumlah'];
