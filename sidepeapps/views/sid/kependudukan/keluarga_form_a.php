            ...
            <div class="col-md-3">
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <?php endif; ?>
                  <br/>
                  <p class="text-muted text-center small"> (Kosongkan jika tidak ingin mengubah foto)</p>
                  <br/>
                  <div class="input-group input-group-sm">
                    <input type="text" class="form-control" id="file_path" name="foto" style="border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
                    <input type="file" class="hidden" id="file" name="foto">
                    <input type="hidden" name="old_foto" value="<?= $penduduk['foto']?>">
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-info btn-radius" id="file_browser" style="margin-left:5px;">Browse</button>
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-9">
              <div class='box box-primary'>
                  ...
                  <div class="row">
                    ...
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <div class="input-group input-group-sm date">
                          ...
                          <input class="form-control input-sm pull-right" id="tgl_1" name="tanggallahir" type="text" value="<?= $penduduk['tanggallahir']?>" style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;">
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <div class="input-group input-group-sm date">
                          ...
                          <input class="form-control input-sm pull-right" id="jammenit_1" name="waktu_lahir" type="text" value="<?= $penduduk['waktu_lahir']?>" style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;">
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-4'>
                    ...
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <div class="input-group input-group-sm date">
                          ...
                          <input class="form-control input-sm pull-right" id="tgl_2" name="dokumen_pasport" type="text" value="<?= $penduduk['dokumen_pasport']?>" style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;">
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-8'>
                    ...
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <a href="<?=site_url("penduduk/ajax_penduduk_maps/$p/$o/$penduduk[id]")?>" title="Lokasi <?= $penduduk['nama']?>" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Lokasi <?= $penduduk['nama']?>" class="btn btn-radius bg-orange btn-sm">Cari Lokasi Tempat Tinggal</a>
                    ...
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <div class="input-group input-group-sm date">
                          ...
                          <input class="form-control input-sm pull-right" id="tgl_3" name="tanggalperkawinan" type="text" value="<?= $penduduk['tanggalperkawinan']?>" style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;">
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-8'>
                    ...
                    <div class='col-sm-4'>
                      <div class='form-group'>
                        ...
                        <div class="input-group input-group-sm date">
                          ...
                          <input class="form-control input-sm pull-right" id="tgl_4" name="tanggalperceraian" type="text" value="<?= $penduduk['tanggalperceraian']?>" style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;">
                        </div>
                      </div>
                    </div>
                    <div class='col-sm-12'>
                ...
                <div class='box-footer'>
                  <div class="row">
                    <div class='col-xs-12'>
                      <button type='reset' class='btn btn-radius btn-danger btn-sm' >Batal</button>
                      <button type='submit' class='btn btn-radius btn-info btn-sm pull-right'>Simpan</button>
                    </div>
                  </div>
                </div>
                  ...
                  <div class='modal-dialog'>
                    <div class='modal-content'>
                      <div class='modal-header'>
                        ...
                        <h4 class='modal-title' id='myModalLabel'>Cari Lokasi Tempat Tinggal</h4>
                      </div>
