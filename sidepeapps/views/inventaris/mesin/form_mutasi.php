<div class="content-wrapper">
	<section class="content-header">
		<h1>Isi Data Mutasi Inventaris Mesin</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url() ?>inventaris_mesin"><i class="fa fa-dashboard"></i>Daftar Inventaris Mesin</a></li>
			<li class="active">Isi Data Mutasi</li>
		</ol>
	</section>
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_mutasi_mesin" method="post" action="<?= site_url("api_inventaris_mesin/add_mutasi"); ?>">
			<div class="row">
				<div class="col-md-3">
				...
				<div class="col-md-9">
					<div class="box box-info">
						<div class="box-header with-border">
							<a href="<?= site_url() ?>inventaris_mesin/mutasi" class="btn btn-social btn-flat btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Mesin</a>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="hidden" name="id_inventaris_mesin" id="id_inventaris_mesin" value="<?= $main->id; ?>">
