<div class="content-wrapper">
	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_mesin" method="post" action="<?= site_url("api_inventaris_mesin/add"); ?>">
			<div class="row">
				<div class="col-md-3">
				...
				<div class="col-md-9">
					<div class="box box-info">
						<div class="box-header with-border">
							<a href="<?= site_url() ?>inventaris_mesin" class="btn btn-social btn-flat btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Daftar Inventaris Mesin</a>
						</div>
						<?php
							$reg = ($last_reg->kode + 1);
