<div class="content-wrapper">
	<section class="content-header">
		<h1>Ubah Data Mutasi Inventaris Mesin</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url() ?>inventaris_mesin/mutasi"><i class="fa fa-dashboard"></i>Daftar Mutasi Inventaris Mesin</a></li>
			<li class="active">Ubah Data</li>
		</ol>
	</section>
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_tanah" method="post" action="<?= site_url("api_inventaris_mesin/update_mutasi"); ?>">
			<div class="row">
				<div class="col-md-3">
