<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Daftar Inventaris Kontruksi</div>
		<ol class="breadcrumb">
				...
				<div class="col-md-9">
					<div class="box box-info" style="border-radius:10px; border-top:0;padding:10px">
						<div class="box-header with-border">
							<a href="<?= base_url('inventaris_kontruksi/form')?>" class="btn btn-uppercase btn-radius btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Data Baru" style="background-color:#00ca6d">Tambah Data</a>
													...
													<tbody>
														<?php foreach ($main as $data): ?>
															<tr>
																<td></td>
																<td nowrap>
																	<a href="<?= base_url('inventaris_kontruksi/view/'.$data->id); ?>" title="Lihat Data" class="btn btn-info btn-radius-sm btn-sm"><i class="fa fa-eye"></i></a>
																	<a href="<?= base_url('inventaris_kontruksi/edit/'.$data->id); ?>" title="Edit Data"  class="btn bg-orange btn-radius-sm btn-sm"><i class="fa fa-edit"></i> </a>
																	<a href="#" data-href="<?= site_url("api_inventaris_kontruksi/delete/$data->id")?>" class="btn bg-maroon btn-radius-sm btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																</td>
