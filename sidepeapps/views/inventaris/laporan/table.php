																...
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_tanah'); ?>" title="Lihat Data" type="button" class="btn btn-radius-sm btn-info btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_peralatan'); ?>" title="Lihat Data" type="button" class="btn btn-radius-sm btn-info btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_gedung'); ?>" title="Lihat Data" type="button" class="btn btn-radius-sm btn-info btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_jalan/'.$data->id); ?>" title="Lihat Data" type="button" class="btn btn-radius-sm btn-info btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_asset'); ?>" title="Lihat Data" type="button" class="btn btn-radius-sm btn-info btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<div class="btn-group" role="group" aria-label="...">
																			<a href="<?= base_url('index.php/inventaris_kontruksi'); ?>" title="Lihat Data" type="button" class="btn btn-radius-sm btn-info btn-sm"><i class="fa fa-eye"></i></a>
																		</div>
																	</td>
																</tr>
															</tbody>
