<div class="box box-info"  style="border-radius:10px; border-top:0;padding:10px">
	...
	<div class="box-body no-padding">
		...
		<?php }else{ ?>
			<ul class="nav nav-pills nav-stacked">
				<li <?php if ($tip==1): ?>class="active"<?php endif; ?>><a href="<?=site_url($this->controller)?>"><i class="fa fa-list"></i> Daftar Inventaris</a></li>
				<?php if( $this->tab_ini !== 6 ){ ?>
					<li <?php if ($tip==2): ?>class="active"<?php endif; ?>><a href="<?=site_url($this->controller.'/mutasi')?>"><i class="fa fa-share"></i> Mutasi Inventaris</a></li>
				<?php } ?>
			</ul>
		<?php } ?>
	</div>
...
<div class="box box-info" style="border-radius:10px; border-top:0;padding:10px">
	...
	<div class="box-body no-padding">
		<ul class="nav nav-pills nav-stacked">
			...
			<li <?php if ($this->tab_ini == 2): ?>class="active"<?php endif; ?>><a href="<?=site_url('inventaris_mesin')?>"><i class="fa fa-tags"></i> Mesin</a></li>
			<li <?php if ($this->tab_ini == 21): ?>class="active"<?php endif; ?>><a href="<?=site_url('inventaris_elektronik')?>"><i class="fa fa-tags"></i> Elektronik</a></li>
