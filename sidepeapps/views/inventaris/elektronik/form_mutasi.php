<div class="content-wrapper">
	<section class="content-header">
		<h1>Isi Data Mutasi Inventaris Elektronik</h1>
		<ol class="breadcrumb">
	...
	<section class="content" id="maincontent">
		<form class="form-horizontal" id="validasi" name="form_mutasi_peralatan" method="post" action="<?= site_url("api_inventaris_elektronik/add_mutasi"); ?>">
			<div class="row">
				<div class="col-md-3">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="hidden" name="id_inventaris_elektronik" id="id_inventaris_elektronik" value="<?= $main->id; ?>">
