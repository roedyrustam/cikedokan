...
<form action="<?=site_url("user_setting/update/$main[id]")?>" method="POST" id="validasi" enctype="multipart/form-data">
	<div class="modal-body" id="maincontent">
						...
						<div class="form-group">
							...
							<div class="input-group input-group-sm">
								...
								<span class="input-group-btn">
									<button type="button" class="btn btn-info btn-radius" id="file_browser" style="border-top-left-radius:0;border-bottom-left-radius:0"><i class="fa fa-search"></i> Browse</button>
								</span>
							</div>
						</div>
					</div>
		...
		<div class="modal-footer">
			...
			<button type="submit" class="btn btn-radius btn-info btn-sm">Simpan</button>
		</div>
	</div>
</form>
<script>
