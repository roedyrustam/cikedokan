...
<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Daftar Gambar Album</div>
		<ol class="breadcrumb">
				...
				<div class="col-md-12">
					<div class="box box-info">
            			<div class="box-header with-border">
							<a href="<?= site_url("gallery/form_sub_gallery/$gallery")?>" class="btn btn-radius btn-uppercase btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Album">Tambah Gambar Baru</a>
							<?php if ($_SESSION['grup']<4): ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("gallery/delete_all_sub_gallery/$gallery")?>')" class="btn btn-radius btn-uppercase btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hapus-terpilih"><i class='fa fa-trash-o'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
							<a href="<?= site_url("gallery")?>" class="btn btn-radius btn-uppercase btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Kembali Ke Daftar Album">Kembali ke Daftar Album</a>
						</div>
						<div class="box-header with-border">
							<div class="title">Nama Album : <strong><?= $sub['nama']?></strong></div>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12">
													...
													<div class="box-tools">
														<div class="input-group input-group-sm pull-right">
															...
															<div class="input-group-btn">
																<button type="submit" class="btn btn-default" onclick="$('#'+'mainform').attr('action', '<?= site_url("gallery/search/$gallery")?>');$('#'+'mainform').submit();" style="border-top-left-radius:0;border-bottom-left-radius:0"><i class="fa fa-search"></i></button>
															</div>
														</div>
													</div>
												</div>
														...
														<table class="table table-bordered table-striped dataTable table-hover">
															...
															<tbody>
																...
																<tr>
																	...
																	<td><?=$data['no']?></td>
																	<td nowrap>
																		<a href="<?= site_url("gallery/form_sub_gallery/$gallery/$data[id]")?>" class="btn btn-warning btn-radius-sm btn-sm"  title="Ubah"><i class="fa fa-edit"></i></a>
																	<?php if ($_SESSION['grup']<4): ?>
									                                <?php if ($data['enabled'] == '2'): ?>
									                                    <a href="<?= site_url("gallery/gallery_lock/".$data['id']."/$gallery")?>" class="btn bg-navy btn-radius-sm btn-sm"  title="Aktifkan Gambar"><i class="fa fa-lock">&nbsp;</i></a>
									                                <?php elseif ($data['enabled'] == '1'): ?>
									                                    <a href="<?= site_url("gallery/gallery_unlock/".$data['id']."/$gallery")?>" class="btn bg-navy btn-radius-sm btn-sm"  title="Non Aktifkan Gambar"><i class="fa fa-unlock"></i></a>
									                                <?php endif ?>
																		<a href="#" data-href="<?= site_url("gallery/delete_sub_gallery/$gallery/$data[id]")?>" class="btn bg-maroon btn-radius-sm btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
										                            <?php endif; ?>
										                            </td>
										                            <td width="60%">
