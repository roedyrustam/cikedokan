<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Rincian Program Bantuan</div>
		<ol class="breadcrumb">
				...
				<div class="box box-info">
					<div class="box-header with-border">
						<?php if ($program[0]["status"] == 0): ?>
							<a href="<?=site_url("program_bantuan/form/".$program[0]['id'])?>" class="btn btn-radius btn-uppercase btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Peserta Baru">Tambah Peserta Baru</a>
						 <?php endif; ?>
						 <a href="<?=site_url("program_bantuan/unduhsheet/$detail[id]/")?>" class="btn btn-radius btn-uppercase bg-navy btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh Data" target="_blank">Unduh</a>
															...
															<?php foreach ($peserta as $key=>$item): $nomer++;?>
																<tr>
																	...
																	<td nowrap class="text-center">
																		<a href="<?= site_url("program_bantuan/edit_peserta_form/$item[id]")?>" class="btn bg-orange btn-radius-sm btn-sm"  title="Ubah" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Ubah Data Peserta"><i class="fa fa-edit"></i></a>
																		<a href="#" data-href="<?= site_url("program_bantuan/hapus_peserta/$detail[id]/$item[id]")?>" class="btn bg-maroon btn-radius-sm btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																	</td>
																	...
																	<td nowrap class="text-center"><?= tgl_indo($item["kartu_tanggal_lahir"]);?></td>
