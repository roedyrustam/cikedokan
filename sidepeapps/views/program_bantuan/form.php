...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="title-header">Peserta Program Bantuan</div>
		<ol class="breadcrumb">
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="box-header with-border">
							<a href="<?= site_url('program_bantuan') ?>" class="btn btn-radius btn-uppercase btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Program Bantuan">Kembali Ke Daftar Program Bantuan</a>
							<a href="<?= site_url("program_bantuan/detail/1/$detail[id]") ?>" class="btn btn-radius btn-uppercase btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Rincian Program Bantuan">Kembali Ke Rincian Program Bantuan</a>
						</div>
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
										...
										<div class="box-body">
											<form action="" id="main" name="main" method="POST" class="form-horizontal">
												<div class="form-group">
													<label class="col-sm-4 col-lg-3 control-label <?php ($detail['sasaran'] != 1) and print('no-padding-top') ?>" for="nik"><?= $detail['judul_cari_peserta'] ?></label>
													<div class="col-sm-7">
												...
												<?php if ($individu) : ?>
													<?php include("sidepeapps/views/program_bantuan/konfirmasi_peserta.php"); ?>
												<?php endif; ?>
											</form>
