<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Disposisi Surat Masuk</div>
		<ol class="breadcrumb">
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<a href="<?= site_url("surat_masuk")?>" class="btn btn-radius btn-uppercase btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Wilayah">Kembali ke Daftar Surat Masuk</a>
					</div>
					<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="mailbox-attachment-info">
											...
											<label class="control-label"><input type="checkbox" name="gambar_hapus" value="<?=  $surat_masuk['berkas_scan']?>" /> Hapus Berkas Lama</label>
										</div>
									</div>
								</div>
							<?php endif; ?>
