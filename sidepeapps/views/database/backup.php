																				...
																				<td style="padding:20px;">
																					<div class="form-group">
																						...
																						<div class="col-sm-12 col-md-3 col-lg-2">
																							<a href="<?= site_url("database")?>/exec_backup" class="btn btn-radius btn-block btn-info btn-sm" style="box-shadow:unset">Unduh</a>
																						</div>
																					</div>
																				</td>
																			</tr>
																			...
																			<tr>
																				<td style="padding:20px;">
																					<div class="form-group">
																						...
																						<div class="col-sm-12 col-md-3 col-lg-2">
																							<button type="submit" class="btn btn-block btn-success btn-sm" style="border-radius:30px"><i class="fa fa-spin fa-refresh"></i>  Restore</button>
																						</div>
																					</div>
																				</td>
																			</tr>
