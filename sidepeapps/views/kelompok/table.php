...
<div class="content-wrapper">
	<section class="content-header">
		<div class="title-header">Pengelolaan Kelompok</div>
		<ol class="breadcrumb">
	...
	<section class="content" id="maincontent">
		<form id="mainform" name="mainform" action="" method="post">
					...
					<div id="bantuan" class="box box-info">
						...
						<div class="box-body no-padding">
							<ul class="nav nav-pills nav-stacked">
								...
								<?php endforeach; ?>
								<li>
									<a class="btn btn-radius bg-purple btn-sm" href="<?= site_url("kelompok_master/clear")?>" style="border-radius:30px">Kelola Kategori Kelompok</a>
								</li>
							</ul>
						</div>
					</div>
            ...
            <div class="box-header with-border">
							<a href="<?= site_url('kelompok/form')?>" title="Tambah kelompok Baru" class="btn btn-radius btn-uppercase bg-olive btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block">Tambah Kelompok Baru</a>
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform','<?= site_url("kelompok/delete_all/$p/$o")?>')" class="btn btn-radius btn-uppercase btn-danger btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block hapus-terpilih">Hapus Data Terpilih</a>
							<a href="<?= site_url("kelompok/cetak")?>" class="btn btn-radius btn-uppercase bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  target="_blank">Cetak Data</a>
							<a href="<?= site_url("kelompok/excel")?>" class="btn btn-radius btn-uppercase bg-orange btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  target="_blank">Unduh Data</a>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-sm-12">
															...
															<tbody>
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<td><?= $data['no']?></td>
																		<td>
																			<a href="<?= site_url("kelompok/anggota/$data[id]")?>" class="btn bg-purple btn-radius-sm btn-sm"  title="Rincian Kelompok"><i class="fa fa-list-ol"></i></a>
																			<a href="<?= site_url("kelompok/form/$p/$o/$data[id]")?>" class="btn bg-orange btn-radius-sm btn-sm"  title="Ubah Data Kelompok"><i class='fa fa-edit'></i></a>
																			<a href="#" data-href="<?= site_url("kelompok/delete/$p/$o/$data[id]")?>" class="btn bg-maroon btn-radius-sm btn-sm"  title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash-o"></i></a>
																		</td>
								...
								<div class='modal-dialog'>
									<div class='modal-content'>
										...
										<div class='modal-footer'>
											...
											<a class='btn-ok'>
												<button type="button" class="btn btn-radius btn-info btn-sm" id="ok-status">Ya</button>
											</a>
										</div>
									</div>
								</div>
