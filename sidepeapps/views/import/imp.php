									...
									<ol>
										...
										<li>Data yang dibutuhkan untuk Impor dengan memenuhi urutan format dan aturan data pada tautan di bawah ini :
											<div class="timeline-footer row">
												<a href="<?= base_url()?>assets/import/FormatImportExcel.xls" class="btn btn-radius btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" wrap>Format Import Data</a>
											</div>
										</li>
									</ol>
								</div>
										...
										<td>
											<div class="form-group" style="padding: 20px;">
												...
												<div class="col-sm-12 col-md-5 col-lg-4">
													<a href="#" class="btn btn-block btn-success btn-sm" title=" Impor Data Penduduk Hapus data penduduk sebelum impor " onclick="document.getElementById('excell').submit();" data-toggle="modal" data-target="#loading" style="border-radius:30px;"> <i class="fa fa-spin fa-refresh"></i> Import Data Penduduk</a>
												</div>
											</div>
										</td>
									</tr>
								...
								<div class="row">
									<ol>
										...
										<li>Data yang dibutuhkan untuk impor dengan memenuhi aturan data, lihat tautan di bawah ini :
											<div class="timeline-footer row">
												<a class="btn btn-radius btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" href="<?= base_url()?>assets/import/ATURANGRUP.xls" >Aturan Data Import</a>
												<a class="btn btn-radius btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" href="<?= base_url()?>assets/import/ContohGrup.xls">Contoh Format Data Import</a>
											</div>
										</li>
									</ol>
								</div>
									...
									<tr>
										<td style="padding:20px;">
											<div class="form-group">
												...
												<div class="col-sm-12 col-md-5 col-lg-4">
													<a href="#" class="btn btn-block btn-success btn-sm"  title="Impor Data Pengelompokan Rumah Tangga" onclick="document.getElementById('kelompok').submit();" data-toggle="modal" data-target="#loading" style="border-radius:30px;"> <i class="fa fa-spin fa-refresh"></i> Import Data Pengelompokan Rumah Tangga</a>
												</div>
											</div>
										</td>
									</tr>
				...
				<div class='modal-dialog'>
					<div class='modal-content'>
						<div class='modal-header btn-warning'>
							<h4 class='modal-title' id='myModalLabel'>Proses Import ......</h4>
						</div>
