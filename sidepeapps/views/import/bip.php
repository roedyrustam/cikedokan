														...
														<div class="row">
															<div class="col-sm-12">
																<form action="<?= $form_action?>" method="post" enctype="multipart/form-data" id="excell" class="form-horizontal">
																	...
																	<a class="btn btn-radius btn-info btn-sm btn-margin visible-xs-block visible-sm-block visible-md-inline-block visible-lg-inline-block" href="<?= base_url()?>assets/import/format_bip_2012.xls" >Contoh BIP 2012</a>
																	<a class="btn btn-radius btn-info btn-sm btn-margin visible-xs-block visible-sm-block visible-md-inline-block visible-lg-inline-block" href="<?= base_url()?>assets/import/format_bip_2016.xls" >Contoh BIP 2016</a>
																	<a class="btn btn-radius btn-info btn-sm btn-margin visible-xs-block visible-sm-block visible-md-inline-block visible-lg-inline-block" href="<?= base_url()?>assets/import/format_bip_ektp.xls">Contoh BIP eKTP</a>
																	<a class="btn btn-radius btn-info btn-sm btn-margin visible-xs-block visible-sm-block visible-md-inline-block visible-lg-inline-block" href="<?= base_url()?>assets/import/format_bip_2016_luwutimur.xls">Contoh BIP 2016 Luwu Timur</a>
																	<a class="btn btn-radius btn-info btn-sm btn-margin visible-xs-block visible-sm-block visible-md-inline-block visible-lg-inline-block" href="<?= base_url()?>assets/import/format_siak.xls">Contoh Data SIAK</a>
																	<p></p>
																			...
																			<tr>
																				<td style="padding:20px;">
																					<div class="form-group">
																						...
																						<div class="col-md-2">
																							<a href="#" class="btn btn-block btn-success btn-sm"  title="Impor Database" onclick="document.getElementById('excell').submit();" data-toggle="modal" data-target="#loading" style="border-radius:30px"> <i class="fa fa-spin fa-refresh"></i> Import BIP</a>
																						</div>
																					</div>
																				</td>
																			</tr>
