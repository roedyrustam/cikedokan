				...
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							...
							<th class="text-center uppercase">Kode Barang</th>
							<th class="text-center uppercase">Nomor Registrasi</th>
							<th class="text-center uppercase">Merk/Type</th>
							<th class="text-center uppercase">Tahun Pembelian</th>
							<th class="text-center uppercase">Asal Usul</th>
						</tr>
					</thead>
					<tbody>
		...
		<?php if( sizeof( $gedung ) > 0 ) { ?>
			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th class="text-center uppercase">Nama Bangunan</th>
							<th class="text-center uppercase">Kode Bangunan</th>
							<th class="text-center uppercase">Nomor Registrasi</th>
						...
						<?php foreach ($gedung as $data) { ?>
							<tr <?php echo ($data->status == "1") ? 'style="background-color:#cacaca"' : ''; ?> >
								...
								<td class="text-center">
									<?php echo tgl_indo( $data->tanggal_dokument ); ?>
								</td>
								<td><?= $data->asal;?></td>
							</tr>
						<?php } ?>
