                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered dataTable table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="#" class="btn bg-olive btn-flat btn-sm"
                                                                            title="Kosongkan"
                                                                            onclick="kosongkan(<?= $s; ?>)"><i
                                                                                class='fa fa-refresh'></i> </a>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <select class="form-control input-sm"
                                                                                name="setting[<?= $s?>][baris]">
                                                                                <option value="">-- Pilih Baris --
                                                                                </option>
                                                                                <?php for ($i=1; $i<11; $i++): ?>
                                                                                <option value="<?= $i;?>"
                                                                                    <?php if ($program['baris']==$i): ?>selected<?php endif ?>>
                                                                                    <?= $i;?></option>
                                                                                <?php endfor?>
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <select class="form-control input-sm"
                                                                                name="setting[<?= $s?>][kolom]">
                                                                                <option value="">-- Pilih Kolom --
                                                                                </option>
                                                                                <?php for ($i=1; $i<4; $i++): ?>
                                                                                <option value="<?= $i;?>"
                                                                                    <?php if ($program['kolom']==$i): ?>selected<?php endif ?>>
                                                                                    <?= $i;?></option>
                                                                                <?php endfor?>
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <input class="form-control input-sm" type="text"
                                                                            placeholder="Judul"
                                                                            name="setting[<?= $s?>][judul]"
                                                                            value="<?= $program['judul']?>" size="40">
                                                                    </td>
                                                                    <td>
                                                                        <input type="hidden"
                                                                            name="setting[<?= $s?>][old_gambar]"
                                                                            value="<?= $program['gambar']?>" />
                                                                        <img class="profile-user-img img-responsive img-circle"
                                                                            src="<?= base_url().'desa/upload/widget/'.$program['gambar']?>"
                                                                            alt="Gambar">
                                                                        <input type="file"
                                                                            name="setting[<?= $s?>][gambar]" />
                                                                        <p class="help-block">(Kosongkan jika tidak
                                                                            ingin mengubah gambar)</p>
                                                                    </td>
                                                                    <td>
                                                                        <input class="form-control input-sm" type="text"
                                                                            placeholder="Tautan"
                                                                            name="setting[<?= $s?>][tautan]"
                                                                            value="<?= $program['tautan']?>" size="40">
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach; ?>
