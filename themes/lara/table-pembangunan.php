	...
	<div class="pembangunan">
		<div class="table-responsive">
			<table class="table table-bordered pmb" style="margin-bottom:0;">
				<tr>
					<th class="text-center uppercase bg-white">Kegiatan Anggaran</th>
					<th class="text-center uppercase bg-white">Lokasi Kegiatan Anggaran</th>
					<th class="text-center uppercase bg-white">Pelaksana Kegiatan Anggaran (PKA)</th>
					<th class="text-center uppercase bg-white nilai">Nilai Kegiatan Anggaran</th>
				</tr>
