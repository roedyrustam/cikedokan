					...
					<div class="form-bottom">
						<?php if ($form == 'nik') : ?>
							<form action="<?php echo site_url('layanan_mandiri/masuk/reset') ?>" method="post" class="form-horizontal form-mandiri">
								...
								<button type="submit" id="but" class="btn btn-success btn-sm center-block">CARI</button>
							</form>
						...
						<?php else : ?>
							<form action="<?php echo site_url('layanan_mandiri/login') ?>" method="post" class="form-horizontal">
								...
								<button type="submit" id="but" class="btn btn-success btn-sm">MASUK LAYANAN PINTAR</button>
							</form>
						<?php endif ?>
					</div>
					<div class="footer-login">
						<a href="<?php echo base_url(); ?>" class="text-default"><?php echo ucwords($this->setting->sebutan_desa) . " " ?><?php echo ucwords($desa['nama_desa']) ?></a>
					</div>
