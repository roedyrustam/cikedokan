				...
				<div class="d-flex">
					<div class="text-white">					
						...
						<div class="number-font">
							<b><?= $indonesia["positif"] ?></b> <span class="caption-corona">Orang</span>
						</div>
						
					</div>
					<div class="ml-auto emot">
						<img src="<?php echo base_url('assets/images/sad-u6e.png')?>" width="45" height="45" alt="Positif">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="card-body">
					<div class="d-flex">
						<div class="text-white">					
							...
							<div class="number-font">
								<b><?= $indonesia["aktif"] ?></b> <span class="caption-corona">Orang</span>
							</div>
							
						</div>
						<div class="ml-auto emot">
							<img src="<?php echo base_url('assets/images/mask.png') ?>" width="45" height="45" alt="Positif">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card-body">
					<div class="d-flex">
						<div class="text-white">					
							...
							<div class="number-font">
								<b><?= $indonesia["meninggal"] ?></b> <span class="caption-corona">Orang</span>
							</div>
							
						</div>
						<div class="ml-auto emot">
							<img src="<?php echo base_url('assets/images/crying.png') ?>" width="45" height="45" alt="Positif">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card-body">
					<div class="d-flex">
						<div class="text-white">					
							...
							<div class="number-font">
								<b><?= $indonesia["sembuh"] ?></b> <span class="caption-corona">Orang</span>
							</div>
							
						</div>
						<div class="ml-auto emot">
							<img src="<?php echo base_url('assets/images/happy-ipM.png') ?>" width="45" height="45" alt="Positif">
						</div>
					</div>
				</div>
			</div>
...
<div class="provdata">
	<div class="row">
		...
		<div class="col-md-4 bg-orange img-card box-primary-shadow text-center">
			<div class="lprovdata">Positif</div>
			<div class="gprovdata"><?= $coronaProvpinsi["Kasus_Posi"] ?> Org</div>
		</div>
		<div class="col-md-4 bg-success img-card box-primary-shadow text-center">
			<div class="lprovdata">Sembuh</div>
			<div class="gprovdata"><?= $coronaProvpinsi["Kasus_Semb"] ?> Org</div>
		</div>
		<div class="col-md-4 bg-secondary img-card box-primary-shadow text-center">
			<div class="lprovdata">Meninggal</div>
			<div class="gprovdata"><?= $coronaProvpinsi["Kasus_Meni"] ?> Org</div>
		</div>
	</div>
</div>
<div class="cfooter">
